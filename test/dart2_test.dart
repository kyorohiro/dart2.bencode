...
void main() {
  unit.group('A group of tests', () {
    unit.test("bencode: string", () {
      ...
      type.Uint8List text = Bencode.decode(out) as type.Uint8List;
    ...
    unit.test("bencode: number", () {
      ...
      num ret = Bencode.decode(out) as num;
...
//  }
    ...
    unit.test("bencode: list", () {
      ...
      List list = Bencode.decode(out) as List;
    ...
    unit.test("bencode: join", () {
      ...
      Map m = Bencode.decode(out) as Map;
    ...
    unit.test("bencode: dictionary", () {
      ...
      Map me = Bencode.decode(out) as Map;
